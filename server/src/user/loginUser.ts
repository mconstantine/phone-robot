...
import { HandlerInput, makeRoute, okRouteResponse, RouteError, RouteResponse } from '../route'
...
function login(input: HandlerInput<LoginInput>): TaskEither<RouteError, RouteResponse<SessionData>> {
  return pipe(
...
export const loginRoute = makeRoute(LoginInput, SessionData, t.unknown, login)
